...
You can download the compendium as a zip from from this URL: <https://github.com/benmarwick/idealspractice/archive/master.zip>

Or you can install this compendium as an R package, idealspractice, from GitHub with:
